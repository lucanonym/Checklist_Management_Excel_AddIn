...
Messages.BotRegistrationNotFoundWith = (botId) => [
    localizeUtils_1.getDefaultString("plugins.bot.BotRegistrationNotFoundWith", botId),
    localizeUtils_1.getLocalizedString("plugins.bot.BotRegistrationNotFoundWith", botId),
];
