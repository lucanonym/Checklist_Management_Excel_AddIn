    ...
    async function importApp(file, appStudioToken, logProvider, overwrite = false) {
        ...
        try {
            ...
            if (((_a = e.response) === null || _a === void 0 ? void 0 : _a.status) === 409) {
                const error = results_1.AppStudioResultFactory.UserError(errors_1.AppStudioError.TeamsAppCreateConflictError.name, errors_1.AppStudioError.TeamsAppCreateConflictError.message(), constants_3.HelpLinks.SwtichTenantOrSub);
                throw error;
            }
