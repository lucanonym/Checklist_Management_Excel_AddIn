...
export declare function handleConfigFilesWhenSwitchAccount(envInfo: v3.EnvInfoV3, appName: string, projectPath: string, hasSwitchedM365Tenant: boolean, hasSwitchedSubscription: boolean, hasBotServiceCreatedBefore: boolean, isCSharpProject: boolean): Promise<Result<undefined, FxError>>;
