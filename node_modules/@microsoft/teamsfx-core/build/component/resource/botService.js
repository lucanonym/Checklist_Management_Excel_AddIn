...
let BotService = class BotService extends azureResource_1.AzureResource {
    ...
    async provision(context, inputs, actionContext) {
        ...
        context.envInfo.state[constants_2.ComponentNames.TeamsBot] = aadRes.value;
...
async function createBotAAD(ctx) {
    ...
    const botConfig = ((_a = ctx.envInfo.config.bot) === null || _a === void 0 ? void 0 : _a.appId) && ((_b = ctx.envInfo.config.bot) === null || _b === void 0 ? void 0 : _b.appPassword)
        ? {
            botId: (_c = ctx.envInfo.config.bot) === null || _c === void 0 ? void 0 : _c.appId,
            botPassword: (_d = ctx.envInfo.config.bot) === null || _d === void 0 ? void 0 : _d.appPassword,
        }
        : ctx.envInfo.state[constants_2.ComponentNames.TeamsBot];
    const botAADCreated = (botConfig === null || botConfig === void 0 ? void 0 : botConfig.botId) && (botConfig === null || botConfig === void 0 ? void 0 : botConfig.botPassword);
    if (!botAADCreated) {
