        ...
        if (teamsAppId) {
            try {
                ...
                if (envInfo.envName === environment_1.environmentManager.getLocalEnvName() &&
                    ...
                    const exists = await appStudio_1.AppStudioClient.checkExistsInTenant(teamsAppId, appStudioToken, ctx.logProvider);
                    if (exists) {
                        envInfo.state[constants_3.ComponentNames.AppManifest].teamsAppId = uuid_1.v4();
                    }
                }
            }
        }
