...
exports.manifestUtils = exports.resolveManifestTemplate = exports.ManifestUtils = void 0;
                ...
                case "staticTab":
                    ...
                    if (capability.snippet) {
                        ...
                        if (capability.existingApp) {
                            ...
                            const template = lodash_1.cloneDeep(constants_2.STATIC_TABS_TPL_V3[0]);
                            template.entityId = "index" + staticTabIndex;
                            appManifest.staticTabs.push(template);
                        }
                        staticTabIndex++;
                        ...
                        if (capability.existingApp) {
                            ...
                            if (inputs.features) {
                                ...
                                if (feature === question_1.CommandAndResponseOptionItem.id ||
                                    feature == question_1.WorkflowOptionItem.id) {
                                ...
                                if (scenarios.includes(question_1.BotScenario.CommandAndResponseBot) ||
                                    scenarios.includes(question_1.BotScenario.WorkflowBot)) {
                                    // command and response bot or workflow bot
                                    appManifest.bots = appManifest.bots.concat(constants_2.BOTS_TPL_FOR_COMMAND_AND_RESPONSE_V3);
                                }
    ...
    async getManifest(projectPath, envInfo, ignoreEnvStateValueMissing, telemetryProps) {
        ...
        if (isLocalDebug || ((_b = manifest.validDomains) === null || _b === void 0 ? void 0 : _b.length) === 0) {
            ...
            for (const domain of validDomains) {
                if (((_g = manifest.validDomains) === null || _g === void 0 ? void 0 : _g.indexOf(domain)) == -1) {
