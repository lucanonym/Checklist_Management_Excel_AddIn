...
let AzureFunctionResource = class AzureFunctionResource extends azureAppService_1.AzureAppService {
    ...
    async configure(context, inputs) {
        ...
        const resourceId = error_1.CheckThrowSomethingMissing(this.alias, "resourceId", (_a = context.envInfo.state[constants_1.ComponentNames.TeamsApi]) === null || _a === void 0 ? void 0 : _a[constants_1.FunctionOutputs.resourceId.key]);
        const credentials = error_1.CheckThrowSomethingMissing(this.alias, "Azure account", await context.tokenProvider.azureAccountProvider.getAccountCredentialAsync());
