...
class SSODebugHandler {
    ...
    async registerAAD() {
        try {
            ...
            this.envInfoV3.state[constants_2.ComponentNames.AadApp] =
                this.envInfoV3.state[constants_2.ComponentNames.AadApp] || {};
            // use existing AAD
            if (this.existing) {
                // set objectId, clientId, clientSecret, oauth2PermissionScopeId from args to state
                this.envInfoV3.state[constants_2.ComponentNames.AadApp].objectId = this.args.objectId;
                this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientId = this.args.clientId;
                this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientSecret = this.args.clientSecret;
                this.envInfoV3.state[constants_2.ComponentNames.AadApp].oauth2PermissionScopeId =
                    this.args.accessAsUserScopeId || uuid_1.v4();
                return teamsfx_api_1.ok([ssoDebugMessages.useExistingAAD]);
            }
            // set oauth2PermissionScopeId to state
            this.envInfoV3.state[constants_2.ComponentNames.AadApp].oauth2PermissionScopeId =
                this.envInfoV3.state[constants_2.ComponentNames.AadApp].oauth2PermissionScopeId || uuid_1.v4();
            // AAD already registered
            if (this.envInfoV3.state[constants_2.ComponentNames.AadApp].objectId &&
                this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientId) {
                if (!this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientSecret) {
                    await tokenProvider_1.TokenProvider.init({
                        m365: this.m365TokenProvider,
                    });
                    const config = new configs_1.ProvisionConfig(true, false);
                    config.objectId = this.envInfoV3.state[constants_2.ComponentNames.AadApp].objectId;
                    config.clientId = this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientId;
                    ...
                    this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientSecret = config.password;
                }
                return teamsfx_api_1.ok([ssoDebugMessages.AADAlreadyRegistered]);
            }
            await tokenProvider_1.TokenProvider.init({
                m365: this.m365TokenProvider,
            });
            ...
            this.envInfoV3.state[constants_2.ComponentNames.AadApp].objectId = config.objectId;
            this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientId = config.clientId;
            this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientSecret = config.password;
            return teamsfx_api_1.ok([ssoDebugMessages.AADRegistered]);
        }
        catch (error) {
        ...
        try {
            ...
            if (projectSettingsHelper_1.ProjectSettingsHelper.includeFrontend(this.projectSettingsV3)) {
                ...
                if (!projectSettingsHelper_1.ProjectSettingsHelper.includeBot(this.projectSettingsV3)) {
                    applicationIdUri += this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientId;
                }
            }
            if (projectSettingsHelper_1.ProjectSettingsHelper.includeBot(this.projectSettingsV3)) {
                applicationIdUri += `botid-${this.envInfoV3.state[constants_2.ComponentNames.TeamsBot].botId}`;
            }
            this.envInfoV3.state[constants_2.ComponentNames.AadApp].applicationIdUris = applicationIdUri;
            // set frontendEndpoint to state
            if (projectSettingsHelper_1.ProjectSettingsHelper.includeFrontend(this.projectSettingsV3)) {
                this.envInfoV3.state[constants_2.ComponentNames.AadApp].frontendEndpoint = "https://localhost";
            }
            // set botId, botEndpoint to state
            if (projectSettingsHelper_1.ProjectSettingsHelper.includeBot(this.projectSettingsV3)) {
                this.envInfoV3.state[constants_2.ComponentNames.AadApp].botId =
                    this.envInfoV3.state[constants_2.ComponentNames.TeamsBot].botId;
                this.envInfoV3.state[constants_2.ComponentNames.AadApp].botEndpoint =
                    this.envInfoV3.state[constants_2.ComponentNames.TeamsBot].siteEndpoint;
            }
            await tokenProvider_1.TokenProvider.init({
                m365: this.m365TokenProvider,
            });
            // set tenantId, oauthHost, oauthAuthority to state
            this.envInfoV3.state[constants_2.ComponentNames.AadApp].tenantId = tokenProvider_1.TokenProvider.tenantId;
            this.envInfoV3.state[constants_2.ComponentNames.AadApp].oauthHost = constants_1.Constants.oauthAuthorityPrefix;
            this.envInfoV3.state[constants_2.ComponentNames.AadApp].oauthAuthority = `${constants_1.Constants.oauthAuthorityPrefix}/${tokenProvider_1.TokenProvider.tenantId}`;
            const context = this.constructPluginContext(this.envInfoV3, this.cryptoProvider);
            const manifest = await aadAppManifestManager_1.AadAppManifestManager.loadAadManifest(context);
        ...
        try {
            ...
            if (projectSettingsHelper_1.ProjectSettingsHelper.includeFrontend(this.projectSettingsV3)) {
                ...
                frontendEnvs.teamsfx[localEnvProvider_1.LocalEnvKeys.frontend.teamsfx.ClientId] =
                    this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientId;
                frontendEnvs.teamsfx[localEnvProvider_1.LocalEnvKeys.frontend.teamsfx.LoginUrl] = `${this.envInfoV3.state[constants_2.ComponentNames.TeamsTab].endpoint}/auth-start.html`;
            ...
            if (projectSettingsHelper_1.ProjectSettingsHelper.includeBackend(this.projectSettingsV3)) {
                ...
                backendEnvs.teamsfx[localEnvProvider_1.LocalEnvKeys.backend.teamsfx.ClientSecret] =
                    this.envInfoV3.state[constants_2.ComponentNames.AadApp].clientSecret;
                backendEnvs.teamsfx[localEnvProvider_1.LocalEnvKeys.backend.teamsfx.TenantId] =
                    this.envInfoV3.state[constants_2.ComponentNames.AadApp].tenantId;
                backendEnvs.teamsfx[localEnvProvider_1.LocalEnvKeys.backend.teamsfx.AuthorityHost] =
                    this.envInfoV3.state[constants_2.ComponentNames.AadApp].oauthHost;
            ...
            if (projectSettingsHelper_1.ProjectSettingsHelper.includeBot(this.projectSettingsV3)) {
                ...
                botEnvs.teamsfx[localEnvProvider_1.LocalEnvKeys.bot.teamsfx.AuthorityHost] =
                    this.envInfoV3.state[constants_2.ComponentNames.AadApp].oauthHost;
                botEnvs.teamsfx[localEnvProvider_1.LocalEnvKeys.bot.teamsfx.LoginEndpoint] = `${this.envInfoV3.state[constants_2.ComponentNames.AadApp].botEndpoint}/auth-start.html`;
                botEnvs.teamsfx[localEnvProvider_1.LocalEnvKeys.bot.teamsfx.ApplicationIdUri] =
                    this.envInfoV3.state[constants_2.ComponentNames.AadApp].applicationIdUris;
                if (projectSettingsHelper_1.ProjectSettingsHelper.includeBackend(this.projectSettingsV3)) {
