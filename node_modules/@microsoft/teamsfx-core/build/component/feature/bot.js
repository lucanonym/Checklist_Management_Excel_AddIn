...
let TeamsBot = class TeamsBot {
    ...
    async add(context, inputs, actionContext) {
        ...
        // 1. scaffold bot and add bot config
        {
            ...
            const folder = language === constants_2.ProgrammingLanguage.CSharp ? "." : strings_1.CommonStrings.BOT_WORKING_DIR_NAME;
            ...
            botConfig = {
                ...
                provision: language === constants_2.ProgrammingLanguage.CSharp,
                deploy: true,
    ...
    async addBotCapability(inputs, isM365 = false) {
        {
            const manifestCapability = {
                name: inputs[question_1.CoreQuestionNames.Features] === question_3.MessageExtensionItem.id ||
                    inputs[question_1.CoreQuestionNames.Features] === question_3.M365SearchAppOptionItem.id
                    ? "MessageExtension"
                    : "Bot",
            };
            const clonedInputs = Object.assign(Object.assign({}, lodash_1.cloneDeep(inputs)), { validDomain: `{{state.${constants_2.ComponentNames.TeamsBot}.domain}}` });
...
const featureToCapability = new Map([
    ...
    [question_3.WorkflowOptionItem.id, "workflow"],
]);
const featureToScenario = new Map([
    ...
    [question_3.WorkflowOptionItem.id, () => [constants_1.TemplateProjectsScenarios.WORKFLOW_SCENARIO_NAME]],
