...
class CICDImpl {
    ...
    async addCICDWorkflows(context, inputs, envName) {
        ...
        telemetry_helper_1.telemetryHelper.sendStartEvent(context, envInfo, constants_2.LifecycleFuncNames.ADD_CICD_WORKFLOWS, this.commonProperties);
        try {
            ...
            telemetry_helper_1.telemetryHelper.sendResultEvent(context, envInfo, constants_2.LifecycleFuncNames.ADD_CICD_WORKFLOWS, res, this.commonProperties);
            return res;
        }
        catch (e) {
            ...
            if (e instanceof errors_1.PluginError) {
                ...
                telemetry_helper_1.telemetryHelper.sendResultEvent(context, envInfo, constants_2.LifecycleFuncNames.ADD_CICD_WORKFLOWS, result, this.commonProperties);
                return result;
            }
            else {
                // Unrecognized Exception.
                const UnhandledErrorCode = "UnhandledError";
                telemetry_helper_1.telemetryHelper.sendResultEvent(context, envInfo, constants_2.LifecycleFuncNames.ADD_CICD_WORKFLOWS, result_1.FxCICDPluginResultFactory.SystemError(UnhandledErrorCode, [`Got an unhandled error: ${e.message}`, `Got an unhandled error: ${e.message}`], e.innerError), this.commonProperties);
