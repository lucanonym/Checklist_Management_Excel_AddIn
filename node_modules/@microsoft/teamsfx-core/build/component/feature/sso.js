...
let SSO = class SSO {
    ...
    async add(context, inputs) {
        ...
        const isCalledByFeature = inputs.stage === teamsfx_api_1.Stage.addFeature &&
        ...
        // show notification
        if (inputs.platform == teamsfx_api_1.Platform.VSCode && isCalledByFeature) {
        ...
        else if (inputs.platform == teamsfx_api_1.Platform.CLI && isCalledByFeature) {
