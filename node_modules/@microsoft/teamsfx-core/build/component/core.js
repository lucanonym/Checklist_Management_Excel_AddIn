...
exports.preCheck = exports.TeamsfxCore = void 0;
...
let TeamsfxCore = class TeamsfxCore {
    ...
    async create(context, inputs, actionContext) {
        ...
        if (scratch === question_1.ScratchOptionNo.id) {
            ...
            const isInitExistingApp = features === question_2.ExistingTabOptionItem.id;
    ...
    async deploy(context, inputs, actionContext) {
        var _a;
        lodash_1.merge(actionContext === null || actionContext === void 0 ? void 0 : actionContext.telemetryProps, {
            [plugins_1.SolutionTelemetryProperty.IncludeAadManifest]: (_a = inputs[constants_3.Constants.INCLUDE_AAD_MANIFEST]) !== null && _a !== void 0 ? _a : "no",
        });
        ...
        if (inputComponentNames.includes(constants_2.ComponentNames.AadApp)) {
            if (inputs[constants_3.Constants.INCLUDE_AAD_MANIFEST] != "yes" || inputs.platform !== teamsfx_api_1.Platform.CLI) {
                inputComponentNames = inputComponentNames.filter((c) => c !== constants_2.ComponentNames.AadApp);
            }
        }
        const thunks = [];
        ...
        if (!(inputs["include-app-manifest"] && inputs["include-app-manifest"] === "no") &&
            inputComponentNames.includes(constants_2.ComponentNames.AppManifest)) {
            const appManifest = typedi_1.Container.get(constants_2.ComponentNames.AppManifest);
            thunks.push({
...
async function preCheck(projectPath) {
    ...
    const settingsFile = path_1.default.resolve(projectPath, `.${teamsfx_api_1.ConfigFolderName}`, "configs", teamsfx_api_1.ProjectSettingsFileName);
