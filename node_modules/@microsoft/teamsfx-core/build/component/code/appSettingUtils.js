...
async function resetAppSettingsDevelopment(projectPath) {
    ...
    try {
        ...
        const error = new teamsfx_api_1.SystemError(plugins_1.SolutionSource, plugins_1.SolutionError.FailedToResetAppSettingsDevelopment, localizeUtils_1.getDefaultString("core.appSettingsUtil.FailedToResetAppSettingsDevelopment"), localizeUtils_1.getLocalizedString("core.appSettingsUtil.FailedToResetAppSettingsDevelopment"));
