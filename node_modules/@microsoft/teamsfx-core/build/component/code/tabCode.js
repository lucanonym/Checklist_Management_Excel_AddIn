...
let TabCodeProvider = class TabCodeProvider {
    ...
    collectEnvs(ctx) {
        ...
        const simpleAuth = workflow_1.getComponent(ctx.projectSetting, constants_2.ComponentNames.SimpleAuth);
        if (simpleAuth) {
            addToEnvs(env_1.EnvKeys.RuntimeEndpoint, (_j = (_h = (_g = ctx.envInfo) === null || _g === void 0 ? void 0 : _g.state) === null || _h === void 0 ? void 0 : _h[constants_2.ComponentNames.SimpleAuth]) === null || _j === void 0 ? void 0 : _j.endpoint);
        }
        return envs;
    }
    ...
    async doReactBuild(tabPath, envName, telemetryReporter, logger) {
        ...
        const scripts = (_a = (await fs.readJSON(path.join(tabPath, constants_1.FrontendPathInfo.NodePackageFile))).scripts) !== null && _a !== void 0 ? _a : [];
        ...
        if ("build:teamsfx" in scripts && (await fs.pathExists(env_1.envFilePath(envName, tabPath)))) {
