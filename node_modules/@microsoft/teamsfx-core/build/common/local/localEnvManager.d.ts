...
export declare class LocalEnvManager {
    ...
    getNgrokHttpUrl(addr: string | number): Promise<string | undefined>;
    ...
    resolveLocalCertificate(trustDevCert: boolean, localEnvProvider?: LocalEnvProvider): Promise<LocalCertificate>;
    getNgrokTunnelConfig(configFile: string): Promise<Map<string, string>>;
    private retry;
}
