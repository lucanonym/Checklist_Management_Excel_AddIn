...
class LocalEnvManager {
    ...
    async getNgrokHttpUrl(addr) {
        return await ngrok_1.getNgrokHttpUrl(addr);
    }
    ...
    async resolveLocalCertificate(trustDevCert, localEnvProvider) {
    ...
    async getNgrokTunnelConfig(configFile) {
        const res = new Map();
        try {
            const fileContent = await fs.readFile(configFile, "utf8");
            const config = yaml.load(fileContent);
            if (config === null || config === void 0 ? void 0 : config.tunnels) {
                for (const [tunnelName, tunnelConfig] of Object.entries(config.tunnels)) {
            ...
            throw error_1.NgrokConfigError(configFile, e === null || e === void 0 ? void 0 : e.message);
        }
    }
