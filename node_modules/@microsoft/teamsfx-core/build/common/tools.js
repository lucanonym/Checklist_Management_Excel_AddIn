...
async function canAddCICDWorkflows(inputs, ctx) {
    ...
    const isExistingApp = !globalVars_1.isV3()
        ...
        : ((_a = ctx.projectSetting.solutionSettings) === null || _a === void 0 ? void 0 : _a.hostType) === question_1.HostTypeOptionAzure.id &&
...
async function getSideloadingStatus(token) {
    ...
    const instance = axios_1.default.create({
        baseURL: constants_4.getAppStudioEndpoint(),
        timeout: 30000,
    });
        ...
        try {
            ...
            if (result !== undefined) {
                ...
                telemetry_1.sendTelemetryErrorEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.CheckSideloading, new teamsfx_api_1.SystemError("M365Account", "UnknownValue", `AppStudio response code: ${response.status}, body: ${response.data}`), {
                    ...
                    [telemetry_1.TelemetryProperty.CheckSideloadingUrl]: "<check-sideloading-status>",
                });
            }
            return result;
        }
...
exports.AppStudioScopes = [`${constants_4.getAppStudioEndpoint()}/AppDefinitions.ReadWrite`];
...
function getFixedCommonProjectSettings(rootPath) {
    ...
    try {
        ...
        return {
            projectId: (_a = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.projectId) !== null && _a !== void 0 ? _a : undefined,
            isFromSample: (_b = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.isFromSample) !== null && _b !== void 0 ? _b : undefined,
            programmingLanguage: (_c = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.programmingLanguage) !== null && _c !== void 0 ? _c : undefined,
            hostType: (_e = (_d = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.solutionSettings) === null || _d === void 0 ? void 0 : _d.hostType) !== null && _e !== void 0 ? _e : undefined,
            isM365: (_f = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.isM365) !== null && _f !== void 0 ? _f : false,
        };
    }
    catch (_g) {
        return undefined;
