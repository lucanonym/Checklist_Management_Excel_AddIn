...
function NgrokConfigError(file, errorMessage) {
    return new teamsfx_api_1.UserError(exports.CoreSource, "NgrokConfigError", localizeUtils_1.getDefaultString("error.NgrokConfigError", file, errorMessage !== null && errorMessage !== void 0 ? errorMessage : ""), localizeUtils_1.getLocalizedString("error.NgrokConfigError", file, errorMessage !== null && errorMessage !== void 0 ? errorMessage : ""));
}
exports.NgrokConfigError = NgrokConfigError;
