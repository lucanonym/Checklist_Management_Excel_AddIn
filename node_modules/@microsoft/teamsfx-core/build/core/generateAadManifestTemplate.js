...
async function generateAadManifestTemplate(projectFolder, projectSettings, requiredResourceAccess = undefined, updateCapabilities = false) {
    ...
    if (updateCapabilities) {
        ...
        const tabConfig = workflow_1.getComponent(projectSettings, constants_2.ComponentNames.TeamsTab);
        if (tabConfig) {
            tabConfig.sso = true;
        }
        const botConfig = workflow_1.getComponent(projectSettings, constants_2.ComponentNames.TeamsTab);
        if (botConfig) {
            botConfig.sso = true;
        }
    }
